...
class QuizApiTest {
    ...
    void setUp() {
        ...
        Quiz q1 = quizRepository.save(Quiz.builder()
                ...
                .quizType(QuizType.OBJECTIVE).playLimit(3).sortOrder(1)
                .build());
        ...
        Quiz q2 = quizRepository.save(Quiz.builder()
                ...
                .quizType(QuizType.OX).playLimit(2).sortOrder(2)
                .build());
        ...
        Quiz q3 = quizRepository.save(Quiz.builder()
                ...
                .quizType(QuizType.SUBJECTIVE).playLimit(3).sortOrder(3)
                .build());
    ...
    @Test
    @DisplayName("2. POST /quiz/answer - 문제 1개 정답 저장")
    ...
    @Test
    @DisplayName("3. POST /quiz/answer - 문제 1개 오답 저장")
    ...
    void fullFlow_success() throws Exception {
        ...
        // 조회 - answerHistory 3건, currentQuizIndex=3
        mockMvc.perform(get("/events/{eventUrl}", eventUrl))
    ...
    void remainingAttempts_restore() throws Exception {
        // 문제 1 풀기 (remainingAttempts=2 남긴 채 다음 문제 answer 저장 시)
        mockMvc.perform(post("/events/{eventUrl}/quiz/answer", eventUrl)
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"quizId\":" + quiz1Id + ",\"correct\":true,\"remainingAttempts\":2}"));

        // 재접속 조회 - remainingAttempts는 문제 완료 시 null로 초기화됨
        mockMvc.perform(get("/events/{eventUrl}", eventUrl))
                .andDo(print())
